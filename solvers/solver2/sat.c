...
// DG: Newer combinations of gcc and ld don't treat these declarations
// in sat.h as tentative definitions and enforce a stricter version of
// ODR, as it is implementation defined what to do with these types of
// definitions.  c.f. http://c-faq.com/decl/decldef.html. To solve the
// issue, we put the definitions here and replace the previous
// tentative definitions found in sat.h with extern definitions.
